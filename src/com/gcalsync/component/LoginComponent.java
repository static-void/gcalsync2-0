...
public class LoginComponent extends MVCComponent implements ItemCommandListener, ItemStateListener, Runnable {
    ...
    static final Command CMD_TEST = new Command("Test", Command.ITEM, 5);
    ...
    public void commandAction(Command c, Displayable d) {
        try {
            if (c == CMD_SIGNIN)
                ...
                new com.gcalsync.test.TestComponent().handle();
        }catch(Exception e) {
            ErrorHandler.showError("LoginComponent commandAction", e);
        }
    }
    ...
    /**
     * Entry point for new thread - This code runs the sign in
     */
    public void run() {
        try {
            Alert a;
            ...
            ErrorHandler.showError("LoginComponent run", e);
            lblSignIn.setLabel(signInMsg);
        }
    }
